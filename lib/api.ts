...
export function fetchOrders(search = "", status: OrderStatus | null = null): Promise<Order[]> {
...
export function patchProductStatus(productId: string, status: OrderStatus): Promise<void> {
